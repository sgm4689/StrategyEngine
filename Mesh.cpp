...
Mesh::Mesh(Vertex* vertices, int vertNum, UINT* indices, int indNum, Microsoft::WRL::ComPtr<ID3D11Device> device) {
	CalculateTangents(vertices, vertNum, indices, indNum);
	CreateBuffers(vertices, vertNum, indices, indNum, device);
}
...
void Mesh::CreateBuffers(Vertex* vertices, int vertNum, UINT* indices, int indNum, Microsoft::WRL::ComPtr<ID3D11Device> device) {
